    ...
    @update="refresh">
        <template slot="head">
          <label class="titles">结构：</label>
              ...
              <el-select v-model="getData.versions_id" @change="changeSelect('version')" placeholder="请选择版本" v-if="mainStructure_type === '1'">
                  <el-option
              ...
              <el-select v-model="getData.classes" @change="changeSelect('class')" placeholder="请选择年级" v-if="mainStructure_type === '1'">
                  <el-option
              ...
              <el-select v-model="getData.subject" placeholder="请选择科目" v-if="mainStructure_type === '1'">
                  <el-option
              ...
              <el-select v-model="getData.pharse_id" @change="changeSelect('pharse')" placeholder="请选择学阶"  v-if="mainStructure_type === '2'">
                  <el-option
              ...
              <el-select v-model="getData.classes" @change="changeSelect('class')" placeholder="请选择年级"  v-if="mainStructure_type === '2'">
                  <el-option
                  v-for="(item,index) in gradeData"
                  :key="index"
                  :label="item.class"
              ...
              <el-select v-model="getData.subject" placeholder="请选择科目"  v-if="mainStructure_type === '2'">
                  <el-option
                  v-for="item in sujectData"
                  :key="item.value"
                  :label="item.subject"
