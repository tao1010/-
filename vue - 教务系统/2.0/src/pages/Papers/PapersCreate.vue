              ...
              <div v-for="(site,indexA) in bigJson" :key="indexA" class="items">	
                <div v-for="(bigli,indexB) in site.content" :key="indexB">
                      ...
                      @mousedown="draggablefn($event)" @mouseup="draggablefn2($event)">         	       	
		                  <div class="left">
                        <input v-if="smallli.point == null" maxlength="3" class="setScore" type="text" placeholder="设分" @input="toScore(indexA,indexB,indexC,$event)" @mousedown="drag1($event)">
		                    <input v-else class="setScore" maxlength="3" :value="smallli.point" type="text" placeholder="设分" @input="toScore(indexA,indexB,indexC,$event)" @mousedown="drag1($event)"><br>
